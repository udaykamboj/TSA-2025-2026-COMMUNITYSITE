                  ...
                  <div className="flex flex-col h-full justify-between" >
                    ...
                    <div>
                      <div className="mt-auto border-t border-slate-100 pt-4">
                        <p className="flex gap-3 mt-0 items-start mb-3 font-poppins text-sm text-secondary">
                          <svg className="fill-primary min-w-[18px] flex-shrink-0 mt-[2px]" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 2 21 20" fill="none" aria-hidden="true">
                        ...
                        <p className="flex gap-3 mt-0 items-start font-poppins text-sm text-secondary">
                          <svg className="fill-primary min-w-[18px] flex-shrink-0 mt-[2px]" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 20 20" fill="none" aria-hidden="true">
                      ...
                      <div className="inline-flex gap-2 mt-4">
                        {(ev.tags || []).map((t) => (
                          <span className="bg-muted text-secondary border border-slate-200 px-3 py-1 rounded-none text-xs uppercase tracking-widest font-semibold font-poppins" key={t}>{t}</span>
                        ))}
                      </div>
                    </div>
                  </div>

...
export const organizations: Organization[] = [
  {
    ...
    description: "Local food bank serving families in need across the Mill Creek area.",
    status: "approved",
    memberCount: 245,
...
export const events: Event[] = [
  {
    ...
    location: "Mill Creek Community Center",
    address: "100 Main St",
    city: "Mill Creek",
    state: "WA",
    zip: "98391",
  ...
  },
  {
    ...
    type: "Skills Based",
    location: "Mill Creek Senior Center",
  ...
  },
  {
    ...
    type: "Fundraising",
    location: "Mill Creek Public Library",
...
export const assignedRolesData: AssignedRole[] = [
  {
    ...
    zip: "98391",
    country: "USA",
    website: "https://www.millcreekfoodbank.org",
  ...
  },
  {
    ...
    eventEnd: "12/7/2025",
    tearDown: "TBA",
    location: "South Mill Creek High School",
  ...
  },
  {
    ...
    eventName: "Annual Mill Creek Charity Gala",
    eventType: "Mill Creek-wide Fundraising",
    status: "ASSIGNED",
    ...
    eventEnd: "4/18/2026",
    tearDown: "TBA",
    location: "Grand Ballroom, Mill Creek Hall",
    address: "1001 Avenida De Las Americas",
    city: "Mill Creek",
    state: "WA",
    zip: "77010",
    country: "USA",
    website: "https://www.millcreekgala.org",
    hasMissingCertifications: false,
    outstandingTasks: [],
  },
  {
...
export const participationHistory: ParticipationRecord[] = [
  ...
  },
  {
    ...
    program: "Fundraising",
    season: "2025",
    event: "Annual Mill Creek Charity Gala",
...
export const defaultNotifications: Notification[] = [
  ...
  },
  {
    id: "notif-4",
    userEmail: "demo@example.com",
    message: "Welcome to the Mill Creek Community Hub! Complete your profile to get started.",
    type: "info",
    read: true,
  ...
  },
  {
    id: "notif-admin-3",
    userEmail: "admin@example.com",
    message: "Your application for Event Coordinator at Mill Creek Charity Gala has been confirmed.",
    type: "success",
    read: true,
...
export const adminUserProfile: UserProfile = {
  ...
  phone: "(555) 000-1111",
  bio: "Platform administrator and lead volunteer coordinator for Mill Creek region.",
  shirtSize: "L",
  emergencyContact: "John Admin",
  emergencyPhone: "(555) 000-2222",
  employer: "Mill Creek Hub",
}

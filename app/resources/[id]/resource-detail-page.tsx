...
const resourcesData = {
  "1": {
    ...
    description: "Offering comprehensive after-school programs, sports, arts, and mentoring for youth.",
    fullDescription:
      "Resource Center Alpha is dedicated to serving youth in our community by providing safe, supportive spaces for learning, recreation, and personal growth. Our programs include after-school activities, sports leagues, arts and music classes, and one-on-one mentoring. We offer all programs free of charge.",
    ...
    eligibility: "Open to all youth in the community. No income requirements.",
    funding: "Supported by community donations and grants.",
  ...
  "2": {
    ...
    category: "Food",
    description:
      "Emergency food assistance and nutrition programs providing fresh groceries and meal support for residents.",
    fullDescription:
      "Food Assistance Hub is the region's largest hunger relief organization, providing emergency food assistance to residents in need. We distribute fresh produce, proteins, and pantry staples through our network of partner agencies. Our mission is to end hunger and provide nutritional support to vulnerable populations.",
    ...
    eligibility: "Families, seniors, and individuals experiencing food insecurity.",
    funding: "Supported by grants, sponsors, and individual donors.",
  ...
  "3": {
    ...
    description:
      "Professional counseling, therapy, and crisis support services available for all ages.",
    fullDescription:
      "Mental Health Network provides accessible mental health support to individuals and families. Our licensed therapists and counselors offer individual counseling, group therapy, crisis intervention, and psychiatric services. We use a sliding scale fee system to ensure affordability for all.",
    ...
    eligibility: "Open to all ages. Sliding scale fees based on income.",
    funding: "Sliding scale available. Community grants support low-income services.",
  ...
  "4": {
    ...
    fullDescription:
      "Senior Housing Support provides affordable housing solutions and comprehensive support services for seniors. We offer independent living options and case management services to help seniors age in place with dignity.",
    ...
    eligibility: "Seniors of eligible age. Income limits apply.",
    funding: "Subsidies, grants, and fees based on income.",
  ...
  "5": {
    ...
    fullDescription:
      "Education Access Initiative empowers students from low-income families by providing educational scholarships, mentoring, and academic support. We help students navigate the college application process and provide financial assistance.",
    ...
    impactStats: [
      { label: "Scholarships", value: "$5M+", icon: "💰" },
      { label: "Students", value: "2K+", icon: "📚" },
      { label: "Enrollment", value: "95%", icon: "🎓" },
    ...
    eligibility: "High school students from eligible backgrounds.",
    funding: "Donations from individuals and corporations.",
  ...
  "6": {
    ...
    description: "Financial assistance, rent support, and utility bill help for residents.",
    fullDescription:
      "Emergency Care Helpline provides immediate financial relief to residents facing housing instability, utility disconnection, or other critical needs. Our compassionate team helps people navigate available resources and connect with assistance programs.",
    ...
    impactStats: [
      { label: "Calls", value: "10K+/mo", icon: "📞" },
      { label: "Assistance", value: "$2M+/year", icon: "💵" },
    ...
    eligibility: "Residents facing immediate crisis. Income limits apply.",
    funding: "Grants, foundation funding, and community donations.",
